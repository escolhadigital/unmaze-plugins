 ...
 * @subpackage Webservice_Ed/admin
 */
...
class Webservice_Ed_Admin
{
  ...
  public function display_plugin_setup_page()
  {
    ...
    // TEST
    // include_once( 'partials/webservice-ed-admin-test.php' );

    include_once('partials/webservice-ed-admin-display.php');
  }
  ...
  {
    $options = get_option('webservice-ed');
    return $options;
  }
